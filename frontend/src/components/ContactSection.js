...
const ContactSection = () => {
  ...
  const industries = t('contact.form.industries');
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <h2 className="text-5xl md:text-6xl font-bold text-secondary-900 mb-6">
            {t('contact.title1')}
            <span className="block gradient-text">{t('contact.title2')}</span>
          </h2>
        ...
        <div className="grid lg:grid-cols-2 gap-16 items-start">
          ...
          >
            <div>
              <h3 className="text-3xl font-bold text-secondary-900 mb-4">{t('contact.leftTitle')}</h3>
            ...
            >
              <h4 className="text-secondary-900 font-semibold text-lg mb-3">{t('contact.expectations.title')}</h4>
            ...
            {!isSubmitted ? (
              <form onSubmit={handleSubmit} className="space-y-6 p-8 bg-white/90 backdrop-blur-sm border border-primary-100 rounded-3xl shadow-xl">
                ...
                <div>
                  ...
                  >
                    <option value="">{t('contact.form.placeholders.industry')}</option>
              ...
              >
                ...
                <h3 className="text-2xl font-bold text-secondary-900 mb-4">{t('contact.form.successTitle')}</h3>
