...
import { Sprout, Factory, Heart, ArrowRight, PlayCircle, TrendingUp, Clock, Users } from 'lucide-react';
  ...
  const useCases = [
    {
      ...
      benefits: t('useCases.agriculture.benefits'),
      features: t('useCases.agriculture.features'),
    ...
    },
    {
      ...
      subtitle: t('useCases.manufacturing.subtitle'),
      image: 'https://images.unsplash.com/photo-1752614671119-4868a91efc14',
      description: t('useCases.manufacturing.description'),
      benefits: t('useCases.manufacturing.benefits'),
      features: t('useCases.manufacturing.features'),
    ...
    },
    {
      ...
      subtitle: t('useCases.healthcare.subtitle'),
      image: 'https://images.pexels.com/photos/6153356/pexels-photo-6153356.jpeg',
      description: t('useCases.healthcare.description'),
      benefits: t('useCases.healthcare.benefits'),
      features: t('useCases.healthcare.features'),
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <h2 className="text-5xl md:text-6xl font-bold text-secondary-900 mb-6">
            {t('useCases.title1')}
            <span className="block gradient-text">{t('useCases.title2')}</span>
          </h2>
              ...
              {useCases.map((useCase, index) => {
                ...
                return (
                  ...
                  >
                    ...
                    <span className="hidden sm:block">{useCase.title.split(' ')[0]}</span>
                  </button>
                );
              })}
            </div>
        ...
        >
          ...
          <div className="space-y-8">
            ...
            <div className="space-y-4">
              {useCases[activeCase].benefits && useCases[activeCase].benefits.map((benefit, index) => (
            ...
            >
              <span>{t('useCases.learnMoreBtn')} {useCases[activeCase].title.split(' ')[0]}</span>
