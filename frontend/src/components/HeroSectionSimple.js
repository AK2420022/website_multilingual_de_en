          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="space-y-8">
              ...
              >
                ...
                <span className="block text-primary-600"> {t('hero.headline3')}</span>
              </motion.h1>
              ...
              >
                ...
                >
                  ...
                  <span>{t('hero.viewUseCasesBtn')}</span>
                </motion.button>
              </motion.div>
            </div>
            ...
            <div className="relative">
              ...
              >
                {/* Main Image */}
                <div className="relative rounded-3xl overflow-hidden bg-white/80 backdrop-blur-sm border border-primary-100 p-4 shadow-xl scale-130">
                  <img
                    src="website_image_1.png"
